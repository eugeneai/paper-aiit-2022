...
One of the challenging problem is course documentation, such as syllabi, mediation the previous version with the current curriculum.  For syllabi, following steps are to be performed:
\begin{enumerate}
...
\begin{frame}
  ...
  \begin{itemize}
  \item Syllabi published on ISU website for the active students' groups
...
\begin{frame}[fragile]
  \frametitle{Syllabi PDF analysis}
...
\begin{frame}[fragile]
  \frametitle{Syllabi recognition scenario for IMIT, ISU}
...
:- object(syllabus_recognizer(_XML_, _HTML_File_Name_, _Document_IRI_),
          ...
          imports([syllabus_fonts, text_attrib, degraded, text_features,
                   syllabus_merge, text_syllabus_sections, gather_items,
                   syllabus_page_one, text_syllabus_fields, grouping,
   ...
   process :-
      ::process_syllabus_fonts, !, ::process_attrs, !,
      ::process_degraded, !,       ::process_runs_merge, !,
      ::process_features, !,       ::process_merge, !,
      ::process_features, !,       ::process_merge, !,
      ::process_first_page, !,     ::process_syllabus_sections, !,
      ::process_item_gathering, !, ::process_merge, !,
      ::process_syllabus_fields, !,::process_grouping(ul), !,
...
\begin{frame}
  ...
  \item Realized MVP-like utilities providing solutions of new problems
    ...
    \item Collecting data from the syllabi documents and store in KG
