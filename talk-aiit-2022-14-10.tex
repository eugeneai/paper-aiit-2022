...
``ISU Schedule'' is a web-application has the following functions:
    ...
    \item[\faCogs] accounting main features of ISU institutions, such as:
        ...
        \item[\faSearch] printing schedules for a auditorium, course, faculty member, and student group;
...
\begin{frame}
    \frametitle{Editing mode functions}
...
\begin{frame}
  ...
  The genetic algorithm constructs a schedule for an institute, accounting
    \begin{itemize}
...
\begin{frame}
    \frametitle{Program execution examle}
...
\begin{frame}
    \frametitle{Program performance}

    \begin{itemize}
        \item For 30 student groups of IMIT, ISU
        \item Near optimal solution is obtained for 5000 iterations (40 minutes)
    \end{itemize}
\end{frame}
